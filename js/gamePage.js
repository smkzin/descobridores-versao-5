...
// // these are the ones that have an interactive game
// var arquivosHtml = [
//   "", //0
//   "", //1
//   "", //2
...
// function AntesProximo(titles, type) {
...
//   if (type == 1 && indice == titles.length - 2) {
...
//   if (type == 0) {
//     window.localStorage.setItem("indice", parseInt(indice) - 1);
//     indice--;
//   } else if (type == 1) {
//     window.localStorage.setItem("indice", parseInt(indice) + 1);
//     indice++;
...
// fetchGames().then((gamesInfo) => {
//   var titles = gamesInfo.map((game) => game.game_name);
...
//   AntesProximo(titles, -1);

//   document
//     .getElementById("Anterior")
//     .addEventListener("click", () => AntesProximo(titles, 0));

//   document
//     .getElementById("Proximo")
//     .addEventListener("click", () => AntesProximo(titles, 1));
// });
